                ...
                {TYPE_OPTIONS.map(({ value, label, Icon }) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-1 items-center justify-center gap-1.5 rounded-[7px] px-2.5 py-1.5 text-[13px] transition-colors duration-quick focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface ${on
                    ...
                    >
                      ...
                      <Check
                        aria-hidden="true"
                        className={`h-3.5 w-3.5 shrink-0 transition-opacity duration-quick ${on ? "opacity-100" : "opacity-0"
                          }`}
                      />
                    </button>
                  );
